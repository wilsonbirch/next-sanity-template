...
export const SITE_DEFAULTS = {
  ...
  headerCta: null as { label: string; href: string; style?: CtaStyle } | null,
  phone: "",
  email: "",
  address: "",
  social: {
...
export type SiteSettings = {
  ...
  headerCta?: { label?: string; href?: string; style?: CtaStyle | null } | null;
  phone?: string | null;
  email?: string | null;
  address?: string | null;
  social?: {
    ...
    headerCta:
      settings?.headerCta?.label && settings?.headerCta?.href
        ? {
            ...
            style: (settings.headerCta.style ?? "primary") as CtaStyle,
          }
